...
const renderJobList = (jobList = 'search') => {
    const jobListEl = jobList === 'search' ? jobListSearchEl : jobListBookmarksEl;
    jobListEl.innerHTML = '';
...
const clickHandler = async event => {
    ...
    //remove the active class from previously active job-items before adding the new one
    ...
    history.pushState(null, '', `/Learn%20JS/rmtDev/#${jobId}`);
